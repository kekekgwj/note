...
/**
 * Created by guoweijie on 2017/10/5.
 */

public class NoteEdit extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //日记文本内容
        final TextView et_title   =(TextView)findViewById(R.id.et_title);
        final TextView et_content =(TextView)findViewById(R.id.et_content);
        //设置软键盘显示模式----总是可见
